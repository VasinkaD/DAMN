...
and *Figure 6-II*. <br>
In addition to the provided files, it also requires the *DAMN_ResNet.keras* model stored in the *ResNet* directory, and the nuclear pore complexes dataset "*Gettingstarted2D_Nup96-AF647.zip*" available at . <br>

https://www.embl.de/download/ries/Example_NPC3D2C/
