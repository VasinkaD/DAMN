...
The results are characterized in the section "Evaluation using simulated data" and Figure 2. <br>
...
The results are characterized in the section "Optical microscopy experimental validation with full control over ground truth" and Figure 4. <br>
