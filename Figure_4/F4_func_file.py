...
def Append_measured_data_files():
    LR_data = np.load("Measured_data/Measured_data_low_res_part_1.npy")
    HR_data = np.load("Measured_data/Measured_data_high_res_part_1.npy")
    for i in range(2,5):
        LR_data = np.append(LR_data, np.load("Measured_data/Measured_data_low_res_part_" + str(i) + ".npy"), axis=0)
        HR_data = np.append(HR_data, np.load("Measured_data/Measured_data_high_res_part_" + str(i) + ".npy"), axis=0)
