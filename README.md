...
In addition to this GitHub repository, the DAMN ConvNet and ResNet models, along with the experimental dataset, are stored in the [Zenodo repository](https://zenodo.org/records/14641652) due to their size.
