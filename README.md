...
<br>
Moreover, the Jupyter notebook requires the original file "eso1037a.tif" of the spiral galaxy image. This 106 MB file can be downloaded as a "Fullsize Original" from the European Southern Observation [ESO](ttps://eso.org/public/images/eso1037a/) repository.
